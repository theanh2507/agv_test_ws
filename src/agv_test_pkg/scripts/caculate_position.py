...
from geometry_msgs.msg import TransformStamped                  # bieu dien moi quan he giua cac tf frame
...
class modbus_node(Node):
    def __init__(self):
        ...
        self.control_robot = self.create_subscription(Twist, "/cmd_vel_out", self.cmd_vel_callback, 10)              # cmd_vel_out
        ...
        self.odomFrameName = "odom"
        self.baseFrameName = "base_link"
    ...
    def read_register(self):
        ...
        # self.get_logger().info(f"total encode R: {self.total_right_encoder} L: {self.total_left_encoder}")
    ...
    ###################### control inverse kinematic ######################
    def map_rad_s_to_analog(self, rad_s, max_rad_vel, analog_max):
        # gioi han rad_s trong [-max_rad_s, max_rad_s]
