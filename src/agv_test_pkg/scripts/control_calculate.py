...
class modbus_node(Node):
    def __init__(self):
        ...
        self.control_robot = self.create_subscription(Twist, "/cmd_vel", self.cmd_vel_callback, 10)
    ...
    def read_register(self):
        ...
        msg =  Int64MultiArray()
        msg.data = [self.value_right_encoder, self.value_left_encoder]
    ...
    def caculate_position(self):
        ...
        self.current_time = self.get_clock().now().to_msg().nanosec                                                                         
        ...
        # Chuyển đổi góc quay sang quaternion
